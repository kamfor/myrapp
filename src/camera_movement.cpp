...
int camera_movement() {
    ...
    joint_angles.push_back(-0.5); // turn head in pitch to -1 rad orientation
    joint_names.push_back("head_yaw");
    joint_angles.push_back(0.3); // turn head in yaw to 1.57 rad orientation

    joint_names2.push_back("head_pitch");
    joint_angles2.push_back(0.5); // turn head in pitch to -1 rad orientation
    joint_names2.push_back("head_yaw");
    joint_angles2.push_back(-0.3); // turn head in yaw to 1.57 rad orientation
